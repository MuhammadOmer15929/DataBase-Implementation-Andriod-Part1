    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    buffer.append("REGNO"+cursor.getString(0)+"\n");
                    buffer.append("CNIC"+cursor.getString(0)+"\n");
                    buffer.append("NAME"+cursor.getString(0)+"\n");
                    buffer.append("FATHERNAME"+cursor.getString(0)+"\n");
                    buffer.append("SEMESTER"+cursor.getString(0)+"\n");
                    buffer.append("GPA"+cursor.getString(0)+"\n");
